...
This directory contains the standalone benchmark evaluation module for SLAI T-Rex. It includes the benchmark data, prompts, evaluation code, summary tooling, and ready-to-run launch scripts.
...
├── evaluate/              # B4O ORGEval LP-structure equivalence tools
