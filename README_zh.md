...
**代码：** [SLAI-AITP/Deepseek-OR](https://github.com/SLAI-AITP/Deepseek-OR)
...
├── README_en.md                 # English version，保留兼容旧链接
└── README_zh.md                 # 中文版
```

## 引用

Citation 信息会在 CPT 数据构建与模型发布模块补齐后统一整理。目前可先引用 [technical report PDF](SLAI%20T-Rex.pdf)。
