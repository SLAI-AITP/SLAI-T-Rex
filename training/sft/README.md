...
It consumes OpenAI-style `messages` JSONL from `../../data/sft`, converts it into a MindSpeed packed instruction dataset, and launches an 8K SFT job on Ascend 910C environments.
...
```bash
bash train_sft_deepseek4_flash_8k.sh
```
