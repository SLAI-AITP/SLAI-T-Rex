...
public:
    explicit WindScaleRopeGrad(const char* name) : OpDef(name)
    {
        ...
        this->Input("scale").ParamType(REQUIRED).DataType({ge::DT_BF16, ge::DT_BF16}).Format(fmt);
