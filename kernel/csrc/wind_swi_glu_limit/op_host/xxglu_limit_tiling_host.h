...
namespace optilingLimit { // 独立 namespace，避免与老 swi_glu_v2/v3 的 optiling::GluTilingCalculator/Tiling4Glu ODR 冲突
...
private:
    mutable optiling::XxGluLimitTilingData tiling_;
};
...
#endif  // OP_XXGLU_LIMIT_TILING_HOST_H   // [Add by GTS-AILab] [feature GTSOps]
