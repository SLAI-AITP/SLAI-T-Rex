 ...
 */
#ifndef CANN_XX_GLU_LIMIT_SINGLE_HPP   // [Add by GTS-AILab] [feature GTSOps]
#define CANN_XX_GLU_LIMIT_SINGLE_HPP   // [Add by GTS-AILab] [feature GTSOps]
#include "xxglu_limit_tiling_kernel_single.h"   // [Add by GTS-AILab] [feature GTSOps]

template<typename ParentClass, typename inType, typename outType>
class GluSingle : public ParentClass {
public:
    __aicore__ inline GluSingle() = default;
    __aicore__ inline ~GluSingle() = default;

    __aicore__ inline void Init(GM_ADDR input_gm, GM_ADDR output_gm, const XxGluLimitSingleTilingData* tiling, TPipe& pipe)
    {
        singleTiling.GetTilingAndOffset(tiling, sizeof(inType));
        InitGmBuffer(input_gm, output_gm);
...
protected:
    __aicore__ inline void InitGmBuffer(GM_ADDR input_gm, GM_ADDR output_gm)
    {
...
#endif // CANN_XX_GLU_LIMIT_SINGLE_HPP   // [Add by GTS-AILab] [feature GTSOps]
